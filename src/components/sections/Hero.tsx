...
export function Hero() {
  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-screen pt-32 pb-24 px-4 md:px-8 lg:px-12 flex items-center justify-center overflow-hidden bg-background snap-start scroll-mt-24">
      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          >
            <div className="inline-block px-6 py-2 bg-background text-peach shadow-inner-soft-sm font-subheading text-xs md:text-sm font-bold uppercase tracking-widest border border-peach/20 rounded-full">
              India's Only Quick Commerce Aggregator
            </div>
          </motion.div>
        ...
        <motion.div
          style={{ y: yPhone }}
          className="lg:col-span-5 relative h-[60vh] lg:h-[80vh] flex justify-center lg:justify-end items-center pointer-events-none mt-12 lg:mt-24"
        >
          <motion.div
          ...
          <motion.div
            ...
            className="absolute bottom-1/3 -right-16 md:-right-24 lg:-right-48 bg-plum text-white font-headline font-black text-2xl md:text-3xl px-6 py-3 shadow-soft rounded-[20px] pointer-events-auto border-2 border-white/20 whitespace-nowrap z-20"
          >
            Save ₹₹₹
          </motion.div>
        </motion.div>
